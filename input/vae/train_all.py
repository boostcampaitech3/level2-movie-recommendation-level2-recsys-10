...
# -- dataset
train_dataset = BaseDataset(path = os.path.join(args.data_dir), mode='train_all') # args.path = '../data/'
...
train_loader = DataLoader(train_dataset, batch_size=args.batch_size, drop_last=True, pin_memory=True, shuffle=False)
